    ...
    <section className={styles.mapSection}>
      <div className={styles.mapContainer}>
        ...
        <div className={styles.mapOverlay}>
          ...
          <a href="https://yandex.uz/maps/?pt=69.286313,41.311039&z=17&l=map" target="_blank" rel="noopener noreferrer" className={styles.mapBtn}>
        ...
        {/* Yandex Map iframe */}
        <iframe
          src="https://yandex.uz/map-widget/v1/?ll=69.286313%2C41.311039&z=16&pt=69.286313,41.311039,pm2rdm"
          width="100%"
          height="100%"
          frameBorder="0"
